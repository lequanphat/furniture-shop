...
!(function (t) {
    ...
    class R extends k {
        ...
        remove() {
            const t = new l();
            return (
                this.currentMask && t.aggregate(this.currentMask.remove(...arguments)).aggregate(this._applyDispatch()),
                t
            );
        }
        get state() {
    ...
    const we = new Map(),
        ...
        Te = (t) =>
            Fe(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(xe(t)) : null,
        De = (t) => {
    ...
    class Pi extends us {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    cs.next(this._element, xi)[0] || cs.prev(this._element, xi)[0] || cs.findOne(xi, this._parent)),
        ...
        static dataApiKeydownHandler(t) {
            ...
            const n = this.matches(Ei)
                    ? this
                    : cs.prev(this, Ei)[0] || cs.next(this, Ei)[0] || cs.findOne(Ei, t.delegateTarget.parentNode),
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    const t =
                            e === Xn ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                        s =
                            e === Xn
                    ...
                    is.on(this._element, t, this._config.selector, (t) => {
                        ...
                        is.on(this._element, s, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger['focusout' === t.type ? Qn : Xn] = e._element.contains(t.relatedTarget)),
                                e._leave();
                        });
                }
    ...
    class fr extends us {
        ...
        _activateParents(t) {
            if (t.classList.contains('dropdown-item'))
                cs.findOne('.dropdown-toggle', t.closest('.dropdown')).classList.add(lr);
            else
                for (const e of cs.parents(t, '.nav, .list-group')) for (const t of cs.prev(e, cr)) t.classList.add(lr);
        }
        _clearActiveClass(t) {
    ...
    [].slice.call(document.querySelectorAll('[data-bs-toggle="dropdown"]')).map(function (t) {
        var e = {
            boundary:
                'viewport' === t.getAttribute('data-bs-boundary') ? document.querySelector('.btn') : 'clippingParents',
        };
        return new Pi(t, e);
    }),
