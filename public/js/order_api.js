jQuery.noConflict();
(function ($) {
    $(document).ready(function(){           //file phải được khai báo ở views/admin/components/link-script.blade.php
        ...
        $('#create-order-form').submit(function (e) {   //khi nhấn submit trên form thì vào hàm này
            ...
            $.ajax({                                    //hàm ajax thường để gửi request HTTP không đồng bộ tới server
                ...
                success: function (response) {          //hàm nếu cái ajax request thành công
                    console.log(response); alert("success");                    //respone từ server
                ...
                error: function (error) {               //hàm nếu lỗi, tương tự như trên
