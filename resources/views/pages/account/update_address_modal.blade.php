<div class="modal fade" id="UpdateAdressModal" tabindex="-1" aria-labelledby="updateAdressTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateBrandTitle">Update Adress </h5>
            ...
            <div class="modal-body">
                ...
                <form id="update-address-form" action="#" method="dialog">
                    ...
                    <label for="is_default"> I have a bike</label><br>
</div>
