<!-- Modal -->
<div class="modal modal-blur fade" id="update-role-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form id="update-role-form" class="modal-content" >
            @csrf
            ...
            <div class="modal-body">
                ...
                <div id="update_role_response" class="alert m-0 d-none"></div>
