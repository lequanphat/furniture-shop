<!-- Modal -->
<div class="modal fade" id="updateEmployeeModal" tabindex="-1" aria-labelledby="updateEmployeeTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateEmployeeTitle">Update Employee</h5>
            ...
            <div class="modal-body">
                ...
                <form id="update-employee-form" action="#" method="dialog">
                    ...
                    <button id="js-cancel-update-employee-btn" type="button"
                        class="btn btn-close float-right px-4 mx-1">Cancel</button>
                </form>
            </div>
        </div>
    </div>
