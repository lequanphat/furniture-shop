                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="row">
                        <div class="col-7 input-icon">
                            <input id="search-customers-input" type="text" class="form-control" placeholder="Search…"
                                value="{{ $search }}">
                        ...
                        <div class="col-5"><select id="select-customers-type" name="type" class="form-select">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="table-responsive">
                            ...
                            <div class="d-flex justify-content-end my-2 js-customers-pagination">
