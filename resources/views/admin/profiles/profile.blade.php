...
@section('content')
  ...
  <div class="d-flex align-items-center justify-content-center"
    ...
    <label for="avatar" class="d-flex align-items-center justify-content-center rounded-circle border"
    ...
    <input class="d-none" type="file" name="avatar" id="avatar" accept="image/*" disabled>
  </div>
</div>
<div class="mb-3 row">
    <div class="col-md-6">
