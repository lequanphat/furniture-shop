                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                    ...
                                    @foreach ($discounts as $discount_item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('discount.detail', $discount_item->discount_id) }}"
                                                >
                                                    <img
                                                        src="{{ asset('svg/view.svg') }}" style="width: 18px;" /></a>
                                ...
                                {{-- Pagination --}}
                                <div
                                    class="d-flex justify-content-end my-2">{{ $discounts->render('common.pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
