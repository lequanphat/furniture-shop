<div class="modal fade" id="UpdateWarrantyModal" tabindex="-1" aria-labelledby="updateWarrantyTitle" aria-hidden="true">
    <div class="modal-dialog">

        <form id="update-warranty-form" action="#" method="dialog">

            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateWarrantyTitle">Update</h5>
                    <!--id updateWarrantyTitle sẽ được gửi từ hàm js có id UpdateWarrantyModal-->
                ...
                <div class="modal-body">
                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="product_detail_ID" name="product_detail_ID" class="form-control form-select">
                                        @foreach ($all_product_detail as $sku)
                                            <option value="{{ $sku->sku }}">{{$sku->sku}}-{{$sku->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="update_warranty_response" class="alert ">
                    </div>
                </div>
