<!-- Modal -->
<div class="modal modal-blur fade" id="update-color-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="update-color-form" action="#" method="dialog" style="width: 60%; margin: 0 auto" data-id="-1">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="update_response" class="alert m-0 d-none"></div>
                </div>
